...
BaseType_t xNetworkInterfaceInitialise( void )
{
	...
	EMACInit(EMAC0_BASE, configCPU_CLOCK_HZ, EMAC_BCONFIG_DMA_PRIO_WEIGHT_1 | EMAC_BCONFIG_PRIORITY_1_1, 1, 1, 0);
	EMACConfigSet(EMAC0_BASE, EMAC_CONFIG_USE_MACADDR0 | EMAC_CONFIG_IF_GAP_96BITS |
							EMAC_CONFIG_3BYTE_PREAMBLE | EMAC_CONFIG_BO_LIMIT_16 |
							EMAC_CONFIG_SA_INSERT | EMAC_CONFIG_FULL_DUPLEX,
							EMAC_MODE_TX_THRESHOLD_16_BYTES | EMAC_MODE_RX_THRESHOLD_64_BYTES,
							0);
	...
	EMACIntRegister(EMAC0_BASE, ETH_IRQHandler);
...
uint32_t ulInterruptCause;
	...
	EMACIntClear(EMAC0_BASE, EMAC_INT_NORMAL_INT);
