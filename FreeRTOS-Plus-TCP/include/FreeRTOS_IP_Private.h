...
} __attribute__( (packed) ) xEthernetHeader_t;
...
} __attribute__( (packed) ) xARPHeader_t;
...
} __attribute__( (packed) ) xIPHeader_t;
...
} __attribute__( (packed) ) xIGMPHeader_t;
...
} __attribute__( (packed) ) xICMPHeader_t;
...
} __attribute__( (packed) ) xUDPHeader_t;
...
#endif
} __attribute__( (packed) ) xTCPHeader_t;
...
} __attribute__( (packed) ) xPseudoHeader_t;
...
} __attribute__( (packed) ) xARPPacket_t;
...
} __attribute__( (packed) ) xIPPacket_t;
...
} __attribute__( (packed) )xICMPPacket_t;
...
} __attribute__( (packed) )xUDPPacket_t;
...
} __attribute__( (packed) ) xTCPPacket_t;
