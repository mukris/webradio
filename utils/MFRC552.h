 ...
 * 		Page 2 contains the last chech digit for the UID, one uint8_t manufacturer internal data, and the lock uint8_ts (see http://www.nxp.com/documents/data_sheet/MF0ICU1.pdf section 8.5.2)
 * 		Page 3 is OTP, One Time Programmable bits. Once set to 1 they cannot revert to 0.
 * 		Pages 4-15 are read/write unless blocked by the lock uint8_ts in page 2.
 * MIFARE Ultralight C (MF0ICU2):
 * 		Has 48 pages of 4 uint8_ts = 64 uint8_ts.
 * 		Pages 0 + 1 is used for the 7-uint8_t UID.
 * 		Page 2 contains the last chech digit for the UID, one uint8_t manufacturer internal data, and the lock uint8_ts (see http://www.nxp.com/documents/data_sheet/MF0ICU1.pdf section 8.5.2)
 * 		Page 3 is OTP, One Time Programmable bits. Once set to 1 they cannot revert to 0.
...
enum PICC_Type
{
	PICC_TYPE_UNKNOWN = 0, PICC_TYPE_ISO_14443_4 = 1,	// PICC compliant with ISO/IEC 14443-4
